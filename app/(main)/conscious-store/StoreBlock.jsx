      ...
      <div>
        {!notify ? (
          <div>
            ...
            <div
              className={`relative hover:scale-105 cursor-pointer h-full transition-all`}
              onClick={(e) => {
          ...
          <div
            className={`relative hover:scale-105 cursor-pointer h-full transition-all`}
          >
            <div className="rounded-md bg-gradient-to-r h-full from-websiteBlue via-pinkishRed to-oceanGreen p-[1.5px]">
              <div className="flex p-3 md:p-2 h-full w-full flex-col rounded-md items-center justify-between bg-white">
                <div className="h-5/6 flex flex-col items-center relative justify-center">
                  <AiOutlineClose
                    onClick={(e) => {
                      setNotify(false);
                    }}
                    className="text-gray-500 absolute text-2xl top-0 right-0"
                  />
      ...
      <>
        {notify ? (
          <>
            {" "}
            <div
              className={`relative hover:scale-105 cursor-pointer h-[35vh] transition-all`}
            >
              <div className="rounded-md bg-gradient-to-r h-full from-websiteBlue via-pinkishRed to-oceanGreen p-[1.5px]">
                <div className="flex p-3 md:p-2 h-full w-full flex-col rounded-md items-center justify-between bg-white">
                  <div className="h-5/6 flex flex-col items-center relative justify-center">
