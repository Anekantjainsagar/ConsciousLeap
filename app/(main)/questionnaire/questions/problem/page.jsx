...
const Block = ({ data }) => {
  ...
  return (
    <div
      ...
      className="rounded-xl mb-4 md:mb-5 mx-auto w-full md:w-[35vw] h-fit bg-gradient-to-r from-websiteBlue via-pinkishRed to-oceanGreen p-[2px] hover:p-[2px] cursor-pointer transitionAnimate hover:scale-105"
    >
