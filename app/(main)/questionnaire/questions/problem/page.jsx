...
const Problem = () => {
  return (
    <div className="w-full md:h-[80vh] min-[1100px]:h-[60vh] flex flex-col items-center justify-center">
...
const Block = ({ data }) => {
  ...
  return (
    <div
      ...
      className="rounded-xl mb-4 md:mb-5 mx-auto w-full md:w-[35vw] min-[1560px]:h-fit min-[950px]:h-[9vh] min-[758px]:h-[10.4vh] bg-gradient-to-r from-websiteBlue via-pinkishRed to-oceanGreen p-[2px] hover:p-[2px] cursor-pointer transitionAnimate hover:scale-105"
    >
