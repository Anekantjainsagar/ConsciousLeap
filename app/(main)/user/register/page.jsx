...
const UserRegister = () => {
  ...
  return (
    <div className="py-10">
      <Toaster />
      <div className="rounded-xl w-[90vw] min-[900px]:w-[40vw] min-[1040px]:w-[35vw] mx-auto bg-gradient-to-r from-websiteBlue via-pinkishRed to-oceanGreen p-[2px]">
        <div className="flex flex-col py-[3vw] px-[4vw] md:px-[1.5vw] md:py-[1.5vw] h-full w-full rounded-xl items-center justify-center bg-white">
          ...
          <input
            ...
            type="text"
            className="w-[78%] min-[400px]:w-[65%] min-[495px]:w-[60%] min-[530px]:w-[55%] min-[580px]:w-[50%] min-[600px]:w-[45%] min-[650px]:w-[40%] min-[777px]:w-[50%] min-[900px]:w-[100%] w-[1050px]:w-[100%] min-[1522px]:w-[90%] min-[1700px]:w-[80%] min-[1900px]:w-[70%] border px-3 py-1.5 outline-none rounded-md mb-4"
            placeholder="Name"
          />
          <input
            type="text"
            ...
            placeholder="Email"
          />
          <div className="w-[78%] min-[400px]:w-[65%] min-[495px]:w-[60%] min-[530px]:w-[55%] min-[580px]:w-[50%] min-[600px]:w-[45%] min-[650px]:w-[40%] min-[777px]:w-[50%] min-[900px]:w-[100%] w-[1050px ]:w-[100%] min-[1522px]:w-[90%] min-[1700px]:w-[80%] min-[1900px]:w-[70%] flex items-center justify-center mb-4">
          ...
          <div className="relative flex items-center justify-center w-full">
            <input
              ...
              className="w-[78%] min-[400px]:w-[65%] min-[495px]:w-[60%] min-[530px]:w-[55%] min-[580px]:w-[50%] min-[600px]:w-[45%] min-[650px]:w-[40%] min-[777px]:w-[50%] min-[900px]:w-[100%] w-[1050px]:w-[100%] min-[1522px]:w-[90%] min-[1700px]:w-[80%] min-[1900px]:w-[70%] border px-3 py-1.5 outline-none rounded-md"
